(() => {
  ...
  var t, n, o = {
      142: (t, n, o) => {
          ...
          var i = o(98);
          n.Character = function Character() {
              var n = this;
              ...
              this.run = function () {
                  if (n.isRunning === !1) {
                      n.donut.classList.add("running");
                      n.isRunning = setInterval(function () {
                          var o = n.collide(n.donut, window.terrain.rock);
                          if (n.isWin || o) {
                              n.stop();
                              n.annotate("Ouch!");
                              n.donut.style.left = "0px";
                              n.characterAnnotation.style.left = n.annotationXPos + "px";
                              window.character = new Character();
                              window.terrain = new i.Terrain();
                          } else {
                              ...
                              if (e >= 1020) {
                                  ...
                                  window.character = new Character();
                                  window.terrain = new i.Terrain();
                                  setTimeout(function () { n.annotate("Yay!") }, 10);
                              } else {
                                  n.characterAnnotation.style.left = r + 2 + "px";
                                  n.donut.style.left = e + 2 + "px";
                              }
                          }
                      }, 10);
                  }
              ...
              this.stop = function () {
                  if (n.isRunning !== !1) {
                      clearInterval(n.isRunning);
                      n.isRunning = !1;
                      n.donut.classList.remove("running");
                  }
              };
              this.jump = function () {
                  if (n.isJumping === !1) {
                      ...
                      n.isJumping = setInterval(function () {
                          ...
                          if (i <= t && t <= i + o && !e) {
                              t = t + 15 >= i + o ? r + 2 : r + 3;
                              n.donut.style.bottom = t + "px";
                              n.characterAnnotation.style.bottom = t + 160 + "px";
                              if (r + 2 >= i + o) e = !0;
                          } else if (i < t && e) {
                              t = t - 30 >= i ? r - 4 : r - 3;
                              n.characterAnnotation.style.bottom = t + 160 + "px";
                              ...
                              clearInterval(n.isJumping);
                              n.isJumping = !1;
                              n.characterAnnotation.style.bottom = i + 160 + "px";
                              n.donut.style.bottom = i + "px";
                          }
                      }, 10);
                  }
              };
              this.annotate = function (t) {
                  n.characterAnnotation.style.opacity = "1";
                  n.characterAnnotation.querySelector(".annotation-wrapper").innerText = t;
                  setTimeout(function () { n.characterAnnotation.style.opacity = "0" }, 5e3);
              };
              this.getProp = function (t) { return getComputedStyle(n.donut).getPropertyValue(t) };
      ...
      98: (t, n) => {
          ...
          n.Terrain = function () {
              ...
              this.rockPosition = 0;
              this.rockSize = 0;
              this.getRandomPosition = function (t, n) {
                  t = Math.ceil(t);
                  n = Math.floor(n);
  ...
  document.addEventListener("DOMContentLoaded", function () {
      window.Character = n.Character;
      window.Terrain = t.Terrain;
  });
})();
